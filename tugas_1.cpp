    ...
    while (true) {
        ...
        if (pilihan == 1) {
            ...
            if (jumlahMahasiswa == 0) {
                ...
                cout << "Pilih nomor mahasiswa yang ingin dihapus (1-" << jumlahMahasiswa << "): ";
                int nomor;
                cin >> nomor;

                if (nomor >= 1 && nomor <= jumlahMahasiswa) {
                    for (int i = nomor - 1; i < jumlahMahasiswa - 1; ++i) {
            ...
            cout << "Masukkan nomor mahasiswa yang ingin diubah (1-" << jumlahMahasiswa << ") ";
            int nomor;
            cin >> nomor;
